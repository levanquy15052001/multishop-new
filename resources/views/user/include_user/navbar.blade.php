                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    ...
                                    <a href="{{ route('index', ['brand' => $item->id]) }}" class="dropdown-item">{{$item->name}} ({{$item->count_product}} item) </a>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="{{route('order')}}" class="btn px-0 ml-3">
                                <i class="fas fa-shopping-cart text-primary"></i>
                                <span class="badge text-secondary border border-secondary rounded-circle sum_order" style="padding-bottom: 2px;"></span>
                            </a>
                        </div>
                    </div>
                </nav>
